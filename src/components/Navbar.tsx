      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link to="/about" dir="rtl" className="text-sm font-medium text-slate-600 hover:text-[#0057B8] transition-colors whitespace-nowrap border border-slate-200 rounded-lg px-3 py-1.5">
              ما هو SPITAR؟
            </Link>
            <LanguageSwitcher />
